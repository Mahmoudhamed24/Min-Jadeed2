 ...
 * 
 * هذا الملف يحتوي على كود Google Apps Script المحدث لمعالجة مشاكل CORS وتخزين البيانات
 * يجب نسخ هذا الكود ولصقه في مشروع Google Apps Script المرتبط بملف Google Sheets
 */

// المتغيرات العامة
let SPREADSHEET_ID = '1gxuf_TWpglt5XnOz5ZKVF14bC7iZ0jrhWSO5cXcvxyg'; // تم تعيين معرف جدول البيانات الفعلي
...
function login(data) {
  ...
  // تسجيل بيانات تسجيل الدخول للتشخيص
...
function signup(data) {
  ...
  // تسجيل بيانات إنشاء الحساب للتشخيص
  Logger.log("Signup attempt for: " + email);
...
/**
 * معالجة طلبات OPTIONS (للتعامل مع CORS)
 */
